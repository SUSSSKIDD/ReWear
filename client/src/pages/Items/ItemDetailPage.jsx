        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col space-y-3">
              {/* Swap This button for non-owners and available items */}
              {!isOwner && item.isAvailable && (
                <button
                  ...
                  className="w-full bg-indigo-600 text-white py-3 rounded-lg font-semibold text-lg shadow-md hover:bg-indigo-700 transition-colors"
                >
                  Swap This
                </button>
              )}
              {isOwner ? (
                <div className="space-y-4">
                  <button
                    ...
                    disabled={!item.isAvailable || (user?.points || 0) < (item.pointsValue || 0)}
                    className={`w-full py-4 px-6 rounded-lg transition-colors font-semibold text-lg ${
                      !item.isAvailable || (user?.points || 0) < (item.pointsValue || 0)
                        ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
                        : 'bg-purple-600 text-white hover:bg-purple-700'
                    }`}
                  >
                    Redeem with Points ({item.pointsValue?.toLocaleString() || 0} pts)
                  </button>
